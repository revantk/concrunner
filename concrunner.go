// Package concrunner is a package for running a max number of functions concurrently.
// It runs those functions keeping goroutines limited to the max number and then waits for them to be done
// It also combines the results and errors of those functions.
...
// If the last return value of the function is of type error then it will combine that into the final MultiError
